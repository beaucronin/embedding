...
b.position.z=10;var c=new THREE.VRControls(b);c.standing=!0;var d=new THREE.WebGLRenderer;d.setSize(window.innerWidth,window.innerHeight),d.setPixelRatio(window.devicePixelRatio),document.body.appendChild(d.domElement);var e=new THREE.VREffect(d);e.setSize(window.innerWidth,window.innerHeight);var g=new WebVRManager(d,e),h=function(a){e.setSize(window.innerWidth,window.innerHeight),b.aspect=window.innerWidth/window.innerHeight,b.updateProjectionMatrix()};window.addEventListener("resize",h,!0),window.addEventListener("vrdisplaypresentchange",h,!0),THREE.input=new i["default"](b,d.domElement),THREE.input.setSize(d.getSize()),a.add(THREE.input.getMesh());var j;return navigator.getVRDisplays().then(function(a){a.length>0&&(j=a[0],j.requestAnimationFrame(f))}),{scene:a,camera:b,manager:g,effect:e,cameraControls:c,vrDisplay:j}}function f(a){a||(a=Date.now());Math.min(a-r,500);r=a;var b=!0,c=!1,d=void 0;try{for(var e,g=q[Symbol.iterator]();!(b=(e=g.next()).done);b=!0){var h=e.value;h.embed()}}catch(i){c=!0,d=i}finally{try{!b&&g["return"]&&g["return"]()}finally{if(c)throw d}}k["default"].update(),THREE.input.update(),cameraControls.update(),manager.render(scene,camera,a),vrDisplay.requestAnimationFrame(f)}function g(a){q.push(a)}Object.defineProperty(c,"__esModule",{value:!0}),c.initScene=e,c.animate=f,c.register=g;var h=a("ray-input"),i=d(h),j=a("tween.js"),k=d(j),l=a("query-string"),m=d(l),n=a("./dataset.js"),o=a("./embedding.js"),p=a("./detection-utils.js"),q=[],r=0;b.exports={Dataset:n.Dataset,WebSocketDataset:n.WebSocketDataset,Embedding:o.Embedding,MeshEmbedding:o.MeshEmbedding,RandomEmbedding:o.RandomEmbedding,ScatterEmbedding:o.ScatterEmbedding,PathEmbedding:o.PathEmbedding,ConsoleEmbedding:o.ConsoleEmbedding,initScene:e,animate:f,queryString:m["default"],detectMode:p.detectMode,register:g}},{"./dataset.js":14,"./detection-utils.js":15,"./embedding.js":16,"query-string":5,"ray-input":9,"tween.js":13}]},{},[17])(17)});