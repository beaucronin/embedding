...
var Hud = exports.Hud = function () {
	...
	_createClass(Hud, [{
		...
		value: function setText(text) {
			...
			// this.scene.add(new THREE.Mesh(new THREE.BoxGeometry(128,64,1), material))
		}
	}]);
